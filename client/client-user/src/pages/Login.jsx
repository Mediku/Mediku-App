    ...
    <div>
      <div className="flex justify-center items-center w-full my-10">
        <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
          <h2 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">
            Login your account
          </h2>
          <form onSubmit={submitLogin}>
            ...
            <button
              class="block bg-blue-600 hover:bg-blue-900 text-white uppercase text-lg mx-auto p-2 rounded"
              type="submit"
            >
              Login account
            </button>
