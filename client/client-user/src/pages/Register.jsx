...
import {fetchProvincesAsync} from '../store/action/index'
function Register() {
    ...
    function addNewUser(e){
        ...
        console.log(payload.full_name, 'dari register');
            ...
            <div className="flex justify-center items-center w-full my-10">
                <div className="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
                    ...
                    <div className="flex flex-row mb-4 justify-between	">
                        ...
                        <select className="border py-2  text-grey-800 p-10 w-80" value={province} onChange={setAddProvince}>
                    ...
                    <div className="flex flex-row mb-4 justify-between	">
                        ...
                        <option selected disabled>--choose regency--</option>
                            ...
                            <option value="regency1">Regency1</option>
                            <option>Regency2</option>
                            <option>Regency3</option>
                            <option>Regency4</option>
                        </select>
                    </div>
                    <div className="flex flex-row mb-4 justify-between	">
                    ...
                    <div className="flex flex-row mb-4 justify-between	">
                        ...
                        <option selected disabled>--choose sub district--</option>
                            ...
                            <option value="subdistrict2">Sub District1</option>
                            <option>Sub District2</option>
                            <option>Sub District3</option>
                            <option>Sub District4</option>
                        </select>
                    </div>
                    <div className="flex flex-row mb-4 justify-between">
